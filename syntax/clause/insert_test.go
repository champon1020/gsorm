...
func TestInsert_Build(t *testing.T) {
	testCases := []struct {
		...
		{
			&clause.Insert{Table: syntax.Table{Name: "table"}},
			&syntax.ClauseSet{Keyword: "INSERT INTO", Value: "table"},
		},
		{
			&clause.Insert{Table: syntax.Table{Name: "table", Alias: "t"}},
			&syntax.ClauseSet{Keyword: "INSERT INTO", Value: "table AS t"},
		},
		{
			&clause.Insert{
				Table:   syntax.Table{Name: "table", Alias: "t"},
			...
			&syntax.ClauseSet{Keyword: "INSERT INTO", Value: "table AS t (column)"},
		},
		{
			&clause.Insert{
				Table:   syntax.Table{Name: "table", Alias: "t"},
			...
			&syntax.ClauseSet{Keyword: "INSERT INTO", Value: "table AS t (column AS c)"},
		},
		{
			&clause.Insert{
				Table:   syntax.Table{Name: "table", Alias: "t"},
			...
			&syntax.ClauseSet{Keyword: "INSERT INTO", Value: "table AS t (column1 AS c1, column2 AS c2)"},
		},
	}
